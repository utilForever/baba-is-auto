...
const std::vector<ObjectEntry>& ObjectCatalog()
{
    ...
    static const std::vector<ObjectEntry> catalog = {
        ...
        { ObjectType::DOOR, "DOOR", "Text: Nouns", ColorU8(238, 238, 238) },
        ...
        { ObjectType::KEY, "KEY", "Text: Nouns", ColorU8(238, 238, 238) },
        { ObjectType::LAVA, "LAVA", "Text: Nouns", ColorU8(238, 238, 238) },
        { ObjectType::LOVE, "LOVE", "Text: Nouns", ColorU8(238, 238, 238) },
        { ObjectType::PILLAR, "PILLAR", "Text: Nouns", ColorU8(238, 238, 238) },
        ...
        { ObjectType::AND, "AND", "Text: Operators", ColorU8(238, 238, 238) },
        ...
        { ObjectType::MOVE, "MOVE", "Text: Properties",
          ColorU8(238, 238, 238) },
        { ObjectType::OPEN, "OPEN", "Text: Properties",
          ColorU8(238, 238, 238) },
        { ObjectType::SHUT, "SHUT", "Text: Properties",
          ColorU8(238, 238, 238) },
        { ObjectType::ICON_ALGAE, "ALGAE", "Objects", ColorU8(84, 150, 64) },
        { ObjectType::ICON_BABA, "BABA", "Objects", ColorU8(236, 236, 236) },
        { ObjectType::ICON_BRICK, "BRICK", "Objects", ColorU8(42, 47, 39) },
        { ObjectType::ICON_CRAB, "CRAB", "Objects", ColorU8(196, 90, 117) },
        { ObjectType::ICON_DOOR, "DOOR", "Objects", ColorU8(196, 90, 117) },
        ...
        { ObjectType::ICON_KEY, "KEY", "Objects", ColorU8(224, 240, 157) },
        { ObjectType::ICON_LAVA, "LAVA", "Objects", ColorU8(225, 74, 52) },
        { ObjectType::ICON_LOVE, "LOVE", "Objects", ColorU8(241, 120, 242) },
        { ObjectType::ICON_PILLAR, "PILLAR", "Objects", ColorU8(81, 111, 148) },
