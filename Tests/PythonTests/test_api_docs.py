...
def test_public_api_has_descriptive_docstrings():
    ...
    documented_apis = (
        ...
        (pyBaba.Game.SetRandomSeed, "Sets the 32-bit random seed"),
        ...
        (pyBaba.Map.MoveObject, "preserving its state"),
        ...
        (pyBaba.Rule, "subject-verb-predicate rule"),
        (pyBaba.Rule.__init__, "Creates an unconditional rule"),
        (
            pyBaba.Rule.__eq__,
            "same objects, conditions, and predicate negation",
        ),
        (pyBaba.RuleCondition, "matching subject instances"),
        (pyBaba.RuleCondition.__init__, "Creates an ON condition"),
        (pyBaba.RuleCondition.__eq__, "same values"),
        (
            inspect.getattr_static(pyBaba.Rule, "conditions"),
            "restricting matching subject instances",
        ),
        (
            inspect.getattr_static(pyBaba.Rule, "negated"),
        ...
        (pyBaba.RuleManager.FindPlayer, "first unconditional YOU rule"),
        (pyBaba.RuleManager.HasProperty, "has the unconditional property"),
        ...
        (pyBaba.IsLockedType, "directional LOCKED property"),
        (pyBaba.IsIconType, "in-game icon"),
